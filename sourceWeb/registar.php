    ...
    <div class="row row-cols-1 row-cols-md-2 mb-3 text-center">
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    <div class="container">
                        <img class="icone" src="../sourceWeb/assets/icons/pessoas.png" alt="Ícone de Cliente">
                    </div>
        ...
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    <div class="container">
                        <img class="icone" src="../sourceWeb/assets/icons/vendedor.png" alt="Ícone de Vendedor">
                    </div>
